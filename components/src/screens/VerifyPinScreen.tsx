...
import { createPin } from "../../../api/config"; // <-- use createPin, NOT verifyPin
...
export default function VerifyPinScreen() {
  ...
  async function handlePinComplete(confirmPin: string) {
    ...
    try {
      ...
      if (!firstPin) {
        setError("Please create a PIN first.");
        router.replace("/pin"); // <-- update to your actual PinScreen route
        return;
      }
